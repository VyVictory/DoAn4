    ...
    <>
      <div className="NavbarUser h-screen w-screen flex  overflow-auto ">
        <div className="w-full  h-full flex items-center flex-col  ">
          ...
          <div className="  py-4   w-full bg-gray-100 flex justify-center">
            <div className="profileW flex flex-row w-full space-x-4 px-10 justify-center">
              <div className="w-1/2 hidden md:block space-y-4 fixed-section">
                <div className="w-full bg-white rounded-md p-2 shadowContent">
              ...
              <div className="flex flex-col w-full space-y-4 scroll-section overflow-y-auto">
                {[...Array(8)].map((_, index) => (
                  <div
                    key={index}
