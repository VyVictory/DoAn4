        ...
        <div className="absolute right-0 mt-14 z-10 divide-y bg-white rounded-lg shadow-lg shadow-gray-500">
          ...
          <div className="py-2 px-2">
            <button
              ...
              className="w-full px-4 py-2 text-sm flex flex-row justify-start items-center hover:bg-gray-200 rounded-lg"
            >
              <svg
              ...
              >
                <path fill="#FFB0AA" d="m31 256 122 100v-50h122V206H153v-50z" />
                <path
                  fill="#6E83B7"
